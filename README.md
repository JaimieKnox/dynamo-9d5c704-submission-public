...
Requires the [GitHub CLI](https://cli.github.com/) (`gh`). Replace `dynamo-9d5c704-model-training-and-ml-infrastructure`
with the repository you were assigned:

```bash
gh repo fork handshake-project-dynamo/dynamo-9d5c704-model-training-and-ml-infrastructure --clone
cd dynamo-9d5c704-model-training-and-ml-infrastructure
git checkout -b submission
#  ... build the task (see below) ...
git add -A && git commit -m "Task submission"
git push -u origin submission
gh pr create --repo handshake-project-dynamo/dynamo-9d5c704-model-training-and-ml-infrastructure --fill
```
