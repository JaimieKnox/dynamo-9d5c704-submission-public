...
This module drove the per step replay of a recorded run: buffer admission, segment
registration, priority proportional sampling, evaluation of the drawn segments and priority
write back. It did not survive the split of the auditor into packages, and only its entry
point and the evaluation helper below came across. Everything else in the package came
across intact.
"""
...
def run_bundle(bundle_dir):
    ...
    """
    raise NotImplementedError("learner replay orchestration did not survive the package split")
