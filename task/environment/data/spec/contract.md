...
Field meanings, dual critic streams, edges, scales, and mass algebra are in `pack-format.md`,
...
`V_t` is the registered `critic_a` stream. `V_next_t` follows the successor rules in the other
spec files.
