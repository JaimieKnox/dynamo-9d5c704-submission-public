...
on the sample bundles, but graded ledgers still diverge where publication timing,
stored scoring epochs, and same-step registration order compose across modules. Repair
the implementation so every normative rule in the docs is honored together.
