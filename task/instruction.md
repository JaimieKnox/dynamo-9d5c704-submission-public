...
λ-return reports. The installed tree finishes every trace, but graded artifacts still diverge
from the normative specs under mixed cuts and pack-specific critic lags.
