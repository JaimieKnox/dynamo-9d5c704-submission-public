...
but graded ledgers diverge when delayed registration, lagged sampler priorities, and
ledger seeding interact across steps. Repair the implementation so those interactions
match the docs.
