...
on the sample bundles, but graded ledgers still diverge where bootstrap choice, draw-phase
mass, and priority write-back timing compose under lag and ring wrap. Repair the
