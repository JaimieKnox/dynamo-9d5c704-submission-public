...
class TransitionBuffer:
    ...
    def segment_is_resident(self, segment):
        """Multi-component residency over every covered admission index."""
        return all(self.is_resident(index) for index in segment.covered_indices())
...
class PriorityRegistry:
    ...
    def importance_mass(self, is_resident_segment):
        """Full-ledger mass for draw gating and IS weights."""
